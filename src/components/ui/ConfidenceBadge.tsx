...
const tierConfig = {
  HIGH_CONFIDENCE: {
    ...
    icon: ShieldAlert,
    className: 'rounded-full border bg-signal-red/10 text-signal-red border-signal-red/30 font-medium',
    dot: 'bg-signal-red',
  },
  MEDIUM_CONFIDENCE: {
    ...
    icon: AlertTriangle,
    className: 'rounded-full border bg-signal-amber/10 text-signal-amber border-signal-amber/30 font-medium',
    dot: 'bg-signal-amber',
  },
  NORMAL: {
    ...
    shortLabel: 'Normal',
    icon: CheckCircle,
    className: 'rounded-full border bg-signal-emerald/10 text-signal-emerald border-signal-emerald/30 font-medium',
